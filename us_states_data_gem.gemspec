...
Gem::Specification.new do |spec|
  ...
  spec.homepage                      = "https://github.com/jdsoteldo/us_states_data_gem"

  spec.metadata = {
    "documentation_uri" => "https://github.com/jdsoteldo/us_states_data_gem/blob/main/README.md",
    "homepage_uri"      => "https://github.com/jdsoteldo/us_states_data_gem",
    "source_code_uri"   => "https://github.com/jdsoteldo/us_states_data_gem",
    "wiki_uri"          => "https://github.com/jdsoteldo/us_states_data_gem/blob/main/README.md"
  }
